...
GunBullet::GunBullet(IP& ip, sf::Vector2f position, sf::Vector2f vel, bool ennemy, float damage) : Bullet(ip, "bullet", sf::IntRect(0, 0, 2, 2), position, vel, damage, .1, true, ennemy, false, true, false, true, false) {
