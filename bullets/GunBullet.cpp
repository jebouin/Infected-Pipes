...
GunBullet::GunBullet(IP& ip, sf::Vector2f position, sf::Vector2f vel, bool ennemy) : Bullet(ip, "bullet", sf::IntRect(0, 0, 2, 2), position, vel, 10, .1, true, ennemy, false, true, false, true, false) {
